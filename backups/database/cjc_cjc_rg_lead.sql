...
--
-- Table structure for table `cjc_rg_lead`
--

DROP TABLE IF EXISTS `cjc_rg_lead`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cjc_rg_lead` (
...
--
-- Dumping data for table `cjc_rg_lead`
--

LOCK TABLES `cjc_rg_lead` WRITE;
/*!40000 ALTER TABLE `cjc_rg_lead` DISABLE KEYS */;
/*!40000 ALTER TABLE `cjc_rg_lead` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-02-04  2:22:18
